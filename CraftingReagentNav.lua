...
ProfessionsFrame.CraftingPage.RecipeList.selectionBehavior:RegisterCallback("OnSelectionChanged", enhanceReagentsButtonsAddNavClicks, ProfessionsFrame.CraftingPage)
